						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<spring:bind path="descrizione">
									<input type="text" name="descrizione" id="descrizione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la descrizione della cartella" value="${insert_cartella_attr.descrizione }">
								</spring:bind>
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="importo">
									<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name="importo" id="importo" placeholder="Inserire l'importo della cartella" value="${insert_cartella_attr.importo }">
								</spring:bind>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="contribuente">
								 ...
								 <input type="hidden" id="statoCartella" name="statoCartella" value="${insert_cartella_attr.statoCartella }">
...
<%-- 							      		<option value="${contribuenteItem.id}" ${insert_cartella_attr.contribuente.id == contribuenteItem.id?'selected':''} >${contribuenteItem.nome } ${contribuenteItem.cognome }</option> --%>
<%-- 							      	</c:forEach> --%>
<!-- 							    </select> -->
<!-- 							</div> -->
<!-- 						</div> -->
