    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          ...
          <a class="dropdown-item" href="${pageContext.request.contextPath}/contribuente/insert">Inserisci Contribuenti</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/cartella/search">Ricerca Cartelle Esattoriali</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/cartella/insert">Inserisci Cartelle Esattoriali</a>
        </div>
      </li>
